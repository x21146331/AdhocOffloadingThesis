...
public class SimSettings {
	...
	private void parseApplicationsXML(String filePath)
	{
		...
		try {	
			...
			"max_delay_requirement","secured"}; //maximum delay requirement (sec)
	...
	private void parseEdgeDevicesXML(String filePath)
	{
		try {	
			...
			NodeList datacenterList = join(edgeDevicesDoc.getElementsByTagName("datacenter"),edgeDevicesDoc.getElementsByTagName("adhoc"));
